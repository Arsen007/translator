...
.tablesorter thead tr .header {
	background-image: url('<?php echo Yii::app()->baseUrl?>/images/bg.gif');
...
.tablesorter thead tr .headerSortUp {
	background-image: url('<?php echo Yii::app()->baseUrl?>/images/asc.gif');
}
.tablesorter thead tr .headerSortDown {
	background-image: url('<?php echo Yii::app()->baseUrl?>/images/desc.gif');
}
...
//            });
        ...
        $('#save').click(function(){
            $('#wait_dialog').activity({segments: 8, steps: 3, opacity: 0.1, width: 8, space: 0, length: 12, color: 'white', speed: 1.5}).find('p').text('Saving...');
        ...
        $('#remove').click(function(){
            ...
            $('#wait_dialog').activity({segments: 8, steps: 3, opacity: 0.1, width: 8, space: 0, length: 12, color: 'white', speed: 1.5}).find('p').text('Deleting...');
            $('#wait_dialog').fadeIn('500');
            $.ajax({
...
<div  id="edit">
    ...
    <ul id="edit_buttons_list">
        <li> <button id="remove"><img src="<?php echo Yii::app()->request->baseUrl ?>/images/trash.png" /></button> </li>
        <li> <button id="save"><img src="<?php echo Yii::app()->request->baseUrl ?>/images/save.png" /></button> </li>
        <li> <button id="closeEditPopup"><img src="<?php echo Yii::app()->request->baseUrl ?>/images/close.png" /></button> </li>
    </ul>
